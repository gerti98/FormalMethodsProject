...
#define MODEL_IDENTIFIER LeadCar
#define MODEL_GUID "{c85259b4-e755-4861-bfc5-ecaf2f25263a}"
...
extern void LeadCar_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc LeadCar_setupDataStruc
...
void setDefaultStartValues(ModelInstance *comp) {
  ...
  comp->fmuData->modelData->realParameterData[2].attribute.start = 1.2;
  comp->fmuData->modelData->realParameterData[3].attribute.start = 0.05;
  comp->fmuData->modelData->realParameterData[4].attribute.start = -0.01;
